...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Art\u00EDculo publicado en un n\u00FAmero de una revista de la Edad de Plata espa\u00F1ola';
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Autor de art\u00EDculos en revistas de la Edad de Plata espa\u00F1ola';
    displayName: 'Autor';
    pluralName: 'authors';
    singularName: 'author';
  };
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variantes_nombre: Schema.Attribute.Text;
  };
}
...
export interface ApiIssueIssue extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'N\u00FAmero de una revista de la Edad de Plata espa\u00F1ola';
    displayName: 'N\u00FAmero';
    pluralName: 'issues';
    singularName: 'issue';
  };
  ...
  attributes: {
    ...
    mes: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    numero_orden: Schema.Attribute.Integer;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    url_facsimil: Schema.Attribute.String;
  };
}
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'P\u00E1ginas institucionales editables (Qu\u00E9 es la Edad de Plata, Proyecto, etc.)';
    displayName: 'P\u00E1gina';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Revista de la Edad de Plata espa\u00F1ola';
  ...
  attributes: {
    año_fin: Schema.Attribute.Integer;
    año_inicio: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    lugar_publicacion: Schema.Attribute.String;
